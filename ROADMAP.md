...
**Maturity:** mature core with a broad, partially production-qualified platform · **Last updated:** 2026-08-16 · HEAD `7a9184e`
...
- [ ] Model builds as a content-addressed dependency graph with parallel independent stages. Dockerfile preparation now validates named/numeric `COPY --from` edges, rejects forward or unknown stage references, exposes deterministic dependency lists and topological execution batches, and binds that graph into the authorization plan digest; parallel graph execution remains open.
