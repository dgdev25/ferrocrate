...
- [ ] Replace the remaining `sled` backends to remove `RUSTSEC-2025-0057` (`fxhash`) and `RUSTSEC-2024-0384` (`instant`), including migration and backward-compatibility tests. The volume store now uses SQLite with a tested legacy-sled import and retained rollback copy; witness, container, image, replay, and Compose stores remain to migrate.
