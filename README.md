...
| Linux (aarch64, glibc) | `FerroCrate.Desktop_0.1.0_arm64.deb` or `.AppImage` | [.deb](https://github.com/dgdev25/ferrocrate/releases/download/v0.1.0-unsigned/FerroCrate.Desktop_0.1.0_arm64.deb) &#124; [.AppImage](https://github.com/dgdev25/ferrocrate/releases/download/v0.1.0-unsigned/FerroCrate.Desktop_0.1.0_aarch64.AppImage) | [Install on Linux](#install-on-linux) |
