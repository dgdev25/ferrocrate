# Routes
Single React entry at /, selected in application state; no URL router. App sections include containers, images, volumes, networks, compose, doctor and settings. FleetApp.tsx is a separate fleet experience.
