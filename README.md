...
- **Qualified, not assumed** — every support claim links dated evidence from
  real hosts; desktop acceptance remains host/network-blocked after the
  Windows and Tahoe host prerequisites were restored but both VM SSH routes
  became unreachable, recorded in
