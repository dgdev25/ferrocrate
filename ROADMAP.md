...
**Maturity:** mature core with a broad, partially production-qualified platform · **Last updated:** 2026-08-16 · HEAD `fe4b881`
...
- [ ] Complete successful kernel-backed eBPF monitoring qualification; the rootful Aya packet loader now passes verifier acceptance plus attach/detach cleanup on the qualified Ubuntu row (`docs/evidence/verification/2026-08-16-ebpf-loader.md`), while live policy traffic, security-monitor event delivery, and explicit fallback provenance remain open. Retain explicit iptables/nftables fallback when eBPF is unavailable.
