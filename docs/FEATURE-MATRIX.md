...
| Image architecture scope | Ferrocrate builds and runs images only for the host architecture. It does not emulate foreign architectures and does not support `--platform` builds or multi-architecture manifests. | Parked follow-up: [`ROUND-11-PLAN.md`](remediation/ROUND-11-PLAN.md) |
