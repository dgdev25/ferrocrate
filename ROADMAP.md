...
- [ ] Replace the remaining `sled` backends to remove `RUSTSEC-2025-0057` (`fxhash`) and `RUSTSEC-2024-0384` (`instant`), including migration and backward-compatibility tests. Volume and image stores now use SQLite with tested legacy-sled imports and retained rollback copies; witness, container, replay, and Compose stores remain to migrate.
